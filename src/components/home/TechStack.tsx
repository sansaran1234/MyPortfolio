...
export const TechStack = () => {
  return (
    ...
    >
      <div className="w-full max-w-7xl flex flex-col gap-16">
        <motion.div variants={techStackGridCascade.heading}>
          <SectionIntro
            ...
            description={
              <>
                Our engineering logic is built on a stack of
                precision-engineered tools for speed, reliability, and technical
                elegance.
              </>
            }
          />
      ...
      <motion.div
        className="w-full max-w-7xl mt-12 flex justify-end"
        variants={techStackGridCascade.footer}
      >
