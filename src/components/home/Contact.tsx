    ...
    >
      <div className="w-full max-w-7xl">
        <motion.div variants={contactAmbientReveal.card}>
          <Card
            variant="high"
            className="relative isolate overflow-hidden border border-outline-variant/10 bg-surface-container-high/75 p-12 md:p-24"
          >
            <GradientBackground />

            <div className="relative z-10 flex flex-col gap-12 items-center text-center">
              <div className="flex flex-col gap-6">
                <span className="font-technical text-[10px] uppercase font-black text-primary tracking-[0.4em]">
                  Ready to Build?
                </span>
              ...
              <p className="font-body text-lg text-outline max-w-2xl leading-relaxed">
                Currently available for high-impact projects and architectural
                consulting. If you have a vision that requires technical
              ...
              <div className="grid w-full max-w-5xl grid-cols-1 gap-4 md:grid-cols-3">
                {CONTACT_DETAILS.map((item) => (
                  <Card
                    key={item.label}
                    variant="medium"
                    className="border border-outline-variant/10 bg-surface-container/70 p-6 text-left"
                  >
