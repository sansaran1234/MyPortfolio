...
const PROJECTS = [
  {
    ...
    category: "ERP",
    description:
      "Engineered a factory Job Tracking system for employee performance and a 3D/2D packaging design platform with real-time dieline and texture customization.",
  ...
  },
  {
    ...
    category: "E-commerce",
    description:
      "End-to-End Solutions: Developed comprehensive ordering, shipping, and pickup logistics alongside a robust Back-Office suite for complex product configurations.",
    tools: [
      "Next",
      "TypeScript",
      "Shadcn UI",
  ...
  },
  {
    ...
    description:
      'AI-Driven Development: Built a Next.js platform for automated article generation and a "one-click" AI chat application to streamline content creation.',
    tools: [
      "Next",
      "TypeScript",
      "Shadcn UI",
  ...
  },
  {
    ...
    description:
      "Frontend Excellence: Delivered pixel-perfect, responsive landing pages from Figma using Material UI and Tailwind CSS, ensuring seamless experiences across all devices.",
    tools: [
      "Next",
      "TypeScript",
      "Shadcn UI",
  ...
  },
  {
    ...
    description:
      "Travel & Booking Systems: Developed a high-performance flight booking platform using React and TypeScript, featuring dynamic seat selection, passenger management, and real-time scheduling.",
            ...
            >
              ...
              >
                ...
                >
                  ...
                  <div className="absolute top-4 left-4">
                    <Badge variant="filled" className="px-4 py-1">
                      Featured
                    </Badge>
                  </div>
                </Card>
              ...
              >
                <div className="flex flex-col gap-2">
                  <span className="font-technical text-[10px] uppercase font-black text-primary tracking-[0.2em]">
                    {project.category}
                  </span>
                  <h3 className="font-display text-4xl md:text-5xl font-black text-foreground tracking-tighter">
                    {project.title}
                  </h3>
                </div>
